    ...
    return (
        <div className="home">
            ...
            <p>I'm Gabriel, a <a rel="noopener noreferrer" target="_blank" href="https://github.com/gabrielmgonzaga">Web Developer</a> based in Irvine. 
                Lately, I've been focused on modern JavaScript Development, UX Strategy, and running <a rel="noopener noreferrer" target="_blank" href="https://pxlbypxl.com">Pxl By Pxl</a> design studio.
            </p> 
            <p>
